...
/// Defines the [StepperCustom]'s main axis.
...
/// A material step used in [StepperCustom]. The step can have a title and subtitle,
...
@immutable
class StepItem {
  /// Creates a step for a [StepperCustom].
  ///
...
class _StepperCustomState extends State<StepperCustom>
  ...
  Widget _buildCircleChild(int index, bool oldState) {
    ...
    switch (state) {
      ...
      case StepStateCustom.active:
        return Image.asset(AssetUtils.car, height: 40, fit: BoxFit.fitWidth);
  ...
  Widget build(BuildContext context) {
    ...
    assert(() {
      if (context.findAncestorWidgetOfExactType<StepperCustom>() != null)
